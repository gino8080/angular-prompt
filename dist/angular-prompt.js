...
angular.module('cgPrompt').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('angular-prompt.html',
    ...
    "                <input id=\"cgPromptInput\" type=\"{{options.input}}\" class=\"form-control\"  placeholder=\"{{options.label}}\" ng-model=\"input.name\" required ng-change=\"changed=true\" ng-if=\"!options.values || options.values.length === 0\"/ autofocus=\"autofocus\">\n" +
